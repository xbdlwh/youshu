package com.example.someapp.ui.editDevice.components
...
import com.example.someapp.ui.addDevice.components.AddDeviceForm

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun EditDeviceScaffold(
  onNavigateBack: () -> Unit,
...
//        .verticalScroll(rememberScrollState())
      ...
      AddDeviceForm(
        ...
        typeIdsInUse = emptySet(),
        formState = formState,
        onFormStateChange = onFormStateChange,
        onTypeSelected = onTypeSelected,
        onAddDeviceType = { _, _ -> false },
        onUpdateDeviceType = { _, _, _ -> false },
        onDeleteDeviceType = { false },
        onSubmit = onSubmit
      )
    }
  }
